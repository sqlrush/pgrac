...
/* Class 08 - Connection Exception (pgrac extension) */
#define ERRCODE_CLUSTER_NODE_UNREACHABLE MAKE_SQLSTATE('0','8','R','0','1')
#define ERRCODE_CLUSTER_NODE_EVICTED MAKE_SQLSTATE('0','8','R','0','2')
#define ERRCODE_CLUSTER_JOIN_FAILED MAKE_SQLSTATE('0','8','R','0','3')
#define ERRCODE_CLUSTER_INTERCONNECT_LOST MAKE_SQLSTATE('0','8','R','0','4')
#define ERRCODE_CLUSTER_PROTOCOL_VERSION_MISMATCH MAKE_SQLSTATE('0','8','R','0','5')
...
/* Class 40 - Transaction Rollback (pgrac extension) */
#define ERRCODE_CLUSTER_RECONFIG_ABORT MAKE_SQLSTATE('4','0','R','0','1')
#define ERRCODE_CLUSTER_ISOLATION_FAILED MAKE_SQLSTATE('4','0','R','0','2')
#define ERRCODE_CLUSTER_CACHE_FUSION_RETRY MAKE_SQLSTATE('4','0','R','0','3')
#define ERRCODE_CLUSTER_PI_INVALIDATED_RETRY MAKE_SQLSTATE('4','0','R','0','4')
...
/* Class 53 - Insufficient Resources (pgrac extension) */
#define ERRCODE_CLUSTER_LMS_QUEUE_FULL MAKE_SQLSTATE('5','3','R','0','1')
#define ERRCODE_CLUSTER_GRD_FULL MAKE_SQLSTATE('5','3','R','0','2')
#define ERRCODE_CLUSTER_UNDO_EXHAUSTED MAKE_SQLSTATE('5','3','R','0','3')
#define ERRCODE_CLUSTER_PI_CHAIN_FULL MAKE_SQLSTATE('5','3','R','0','4')
#define ERRCODE_CLUSTER_CR_CHAIN_FULL MAKE_SQLSTATE('5','3','R','0','5')
#define ERRCODE_CLUSTER_RECOVERY_WORKERS_EXHAUSTED MAKE_SQLSTATE('5','3','R','0','6')
#define ERRCODE_CLUSTER_RECONFIG_QUORUM_LOST MAKE_SQLSTATE('5','3','R','0','7')
#define ERRCODE_CLUSTER_PHASE_TRANSITION_TIMEOUT MAKE_SQLSTATE('5','3','R','0','8')
#define ERRCODE_CLUSTER_PHASE_PRECONDITION_FAILED MAKE_SQLSTATE('5','3','R','0','9')
#define ERRCODE_CLUSTER_LMON_SPAWN_FAILED MAKE_SQLSTATE('5','3','R','0','A')
#define ERRCODE_CLUSTER_LMON_NOT_READY MAKE_SQLSTATE('5','3','R','0','B')
#define ERRCODE_CLUSTER_LCK_SPAWN_FAILED MAKE_SQLSTATE('5','3','R','0','C')
#define ERRCODE_CLUSTER_LCK_NOT_READY MAKE_SQLSTATE('5','3','R','0','D')
#define ERRCODE_CLUSTER_DIAG_SPAWN_FAILED MAKE_SQLSTATE('5','3','R','0','E')
#define ERRCODE_CLUSTER_DIAG_NOT_READY MAKE_SQLSTATE('5','3','R','0','F')
#define ERRCODE_CLUSTER_STATS_SPAWN_FAILED MAKE_SQLSTATE('5','3','R','1','0')
#define ERRCODE_CLUSTER_STATS_NOT_READY MAKE_SQLSTATE('5','3','R','1','1')
#define ERRCODE_CLUSTER_SCN_WRAPAROUND_PANIC MAKE_SQLSTATE('5','3','R','1','2')
#define ERRCODE_CLUSTER_IC_STALE_EPOCH_DROP MAKE_SQLSTATE('5','3','R','2','0')
#define ERRCODE_CLUSTER_IC_CHUNK_REASSEMBLY_TIMEOUT MAKE_SQLSTATE('5','3','R','2','1')
#define ERRCODE_CLUSTER_CSSD_SPAWN_FAILED MAKE_SQLSTATE('5','3','R','3','0')
#define ERRCODE_CLUSTER_CSSD_NOT_READY MAKE_SQLSTATE('5','3','R','3','1')
#define ERRCODE_CLUSTER_CSSD_PEER_SUSPECTED MAKE_SQLSTATE('5','3','R','3','2')
#define ERRCODE_CLUSTER_CSSD_PEER_DEAD MAKE_SQLSTATE('5','3','R','3','3')
#define ERRCODE_CLUSTER_QUORUM_LOST MAKE_SQLSTATE('5','3','R','4','0')
#define ERRCODE_CLUSTER_QUORUM_UNCERTAIN MAKE_SQLSTATE('5','3','R','4','1')
#define ERRCODE_CLUSTER_VOTING_DISK_IO_FAILURE MAKE_SQLSTATE('5','3','R','4','2')
#define ERRCODE_CLUSTER_NODE_ID_COLLISION MAKE_SQLSTATE('5','3','R','4','3')
#define ERRCODE_CLUSTER_QVOTEC_SPAWN_FAILED MAKE_SQLSTATE('5','3','R','4','4')
#define ERRCODE_CLUSTER_QVOTEC_NOT_READY MAKE_SQLSTATE('5','3','R','4','5')
#define ERRCODE_CLUSTER_QUORUM_LOST_BACKEND MAKE_SQLSTATE('5','3','R','5','0')
#define ERRCODE_CLUSTER_WRITE_FENCED MAKE_SQLSTATE('5','3','R','5','1')
#define ERRCODE_CLUSTER_RECONFIG_IN_PROGRESS MAKE_SQLSTATE('5','3','R','6','0')
#define ERRCODE_CLUSTER_GES_TIMEOUT MAKE_SQLSTATE('5','3','R','7','0')
#define ERRCODE_CLUSTER_GES_PENDING_FULL MAKE_SQLSTATE('5','3','R','7','1')
#define ERRCODE_CLUSTER_GES_DEADLOCK MAKE_SQLSTATE('5','3','R','7','2')
#define ERRCODE_CLUSTER_GES_CANCEL_PENDING MAKE_SQLSTATE('5','3','R','7','3')
#define ERRCODE_CLUSTER_GES_ILLEGAL_LOCK_CONVERSION MAKE_SQLSTATE('5','3','R','7','4')
#define ERRCODE_CLUSTER_LMS_UNAVAILABLE MAKE_SQLSTATE('5','3','R','8','0')
#define ERRCODE_CLUSTER_LMD_UNAVAILABLE MAKE_SQLSTATE('5','3','R','8','1')
#define ERRCODE_CLUSTER_LMD_WAIT_EDGE_FULL MAKE_SQLSTATE('5','3','R','8','2')
#define ERRCODE_CLUSTER_NATIVE_LOCK_PROBE_TIMEOUT MAKE_SQLSTATE('5','3','R','8','3')
#define ERRCODE_CLUSTER_GCS_BLOCK_RETRANSMIT_EXHAUSTED MAKE_SQLSTATE('5','3','R','9','0')
#define ERRCODE_CLUSTER_GCS_BLOCK_INVALIDATE_TIMEOUT MAKE_SQLSTATE('5','3','R','9','1')
#define ERRCODE_CLUSTER_GCS_BLOCK_STARVATION_EXHAUSTED MAKE_SQLSTATE('5','3','R','9','2')
#define ERRCODE_CLUSTER_LOST_WRITE_DETECTED MAKE_SQLSTATE('5','3','R','9','3')
#define ERRCODE_CLUSTER_SINVAL_QUEUE_FULL MAKE_SQLSTATE('5','3','R','9','4')
#define ERRCODE_CLUSTER_SINVAL_ACK_TIMEOUT MAKE_SQLSTATE('5','3','R','9','5')
#define ERRCODE_CLUSTER_TT_OVERLAY_FULL MAKE_SQLSTATE('5','3','R','9','6')
#define ERRCODE_CLUSTER_TT_STATUS_UNKNOWN MAKE_SQLSTATE('5','3','R','9','7')
#define ERRCODE_CLUSTER_REMOTE_ROW_LOCK_WAIT_NOT_SUPPORTED MAKE_SQLSTATE('5','3','R','9','8')
#define ERRCODE_CLUSTER_CROSS_NODE_WRITE_CONFLICT MAKE_SQLSTATE('5','3','R','9','H')
#define ERRCODE_CLUSTER_MULTIXACT_LOCK_NOT_SUPPORTED MAKE_SQLSTATE('5','3','R','9','9')
#define ERRCODE_CLUSTER_ITL_SLOT_OVERFLOW MAKE_SQLSTATE('5','3','R','9','A')
#define ERRCODE_PREPARE_TRANSACTION_WITH_CLUSTER_SUBTRANS_STATE MAKE_SQLSTATE('5','3','R','9','B')
#define ERRCODE_CLUSTER_MULTIXACT_MEMBER_OVERLAY_MISS MAKE_SQLSTATE('5','3','R','9','C')
#define ERRCODE_CLUSTER_UNDO_RECORD_INVALID_UBA MAKE_SQLSTATE('5','3','R','9','D')
#define ERRCODE_CLUSTER_UNDO_SEGMENTS_HARD_CAP_REACHED MAKE_SQLSTATE('5','3','R','9','E')
#define ERRCODE_CLUSTER_CR_SNAPSHOT_TOO_OLD MAKE_SQLSTATE('5','3','R','9','F')
#define ERRCODE_CLUSTER_CR_CROSS_INSTANCE_UNSUPPORTED MAKE_SQLSTATE('5','3','R','9','G')
#define ERRCODE_CLUSTER_GRD_SHARD_REMASTERING MAKE_SQLSTATE('5','3','R','9','I')
#define ERRCODE_CLUSTER_GRD_STALE_MASTER_GENERATION MAKE_SQLSTATE('5','3','R','9','J')
#define ERRCODE_CLUSTER_GCS_BLOCK_PATH_NOT_REBUILT MAKE_SQLSTATE('5','3','R','9','K')
#define ERRCODE_CLUSTER_GCS_BLOCK_RESOURCE_RECOVERING MAKE_SQLSTATE('5','3','R','9','L')
#define ERRCODE_CLUSTER_GCS_BLOCK_BEFORE_REDO_BOUNDARY MAKE_SQLSTATE('5','3','R','9','M')
#define ERRCODE_CLUSTER_UNDO_WRITEBACK_BOUNDARY_VIOLATION MAKE_SQLSTATE('5','3','R','9','N')
#define ERRCODE_CLUSTER_CLEAN_PAGE_XFER_UNAVAILABLE MAKE_SQLSTATE('5','3','R','9','X')
#define ERRCODE_CLUSTER_WAL_THREAD_ROUTING_MISMATCH MAKE_SQLSTATE('5','3','R','A','0')
#define ERRCODE_CLUSTER_WAL_THREAD_CLAIM_CONFLICT MAKE_SQLSTATE('5','3','R','A','1')
#define ERRCODE_CLUSTER_WAL_STATE_IO_FAILURE MAKE_SQLSTATE('5','3','R','A','2')
#define ERRCODE_CLUSTER_MERGED_RECOVERY_BLOCKED MAKE_SQLSTATE('5','3','R','A','3')
#define ERRCODE_CLUSTER_THREAD_RECOVERY_BLOCKED MAKE_SQLSTATE('5','3','R','A','4')
#define ERRCODE_CLUSTER_SEQUENCE_ALLOC_UNAVAILABLE MAKE_SQLSTATE('5','3','R','A','5')
...
/* Class 55 - Object Not In Prerequisite State (pgrac extension) */
#define ERRCODE_CLUSTER_PCM_STATE_INVALID MAKE_SQLSTATE('5','5','R','0','1')
#define ERRCODE_CLUSTER_BUFFER_PIN_CONFLICT MAKE_SQLSTATE('5','5','R','0','2')
#define ERRCODE_CLUSTER_LOCK_STARVATION MAKE_SQLSTATE('5','5','R','0','3')
#define ERRCODE_CLUSTER_BUFFER_INVALIDATED MAKE_SQLSTATE('5','5','R','0','4')
#define ERRCODE_CLUSTER_MASTER_CHANGED MAKE_SQLSTATE('5','5','R','0','5')
#define ERRCODE_CLUSTER_BLOCK_MISSING_TEMPORARY MAKE_SQLSTATE('5','5','R','0','6')
...
/* Class 57 - Operator Intervention (pgrac extension) */
#define ERRCODE_CLUSTER_FENCE_TRIGGERED MAKE_SQLSTATE('5','7','R','0','2')
#define ERRCODE_CLUSTER_ADMIN_SHUTDOWN MAKE_SQLSTATE('5','7','R','0','3')
#define ERRCODE_CLUSTER_NODE_DRAIN MAKE_SQLSTATE('5','7','R','0','4')
#define ERRCODE_CLUSTER_QUIESCE_ACTIVE MAKE_SQLSTATE('5','7','R','0','5')
#define ERRCODE_CLUSTER_ADG_APPLY_LAG_EXCESSIVE MAKE_SQLSTATE('5','7','R','0','6')
...
#define ERRCODE_CLUSTER_SHARED_STORAGE_FAILED MAKE_SQLSTATE('5','8','R','0','1')
#define ERRCODE_CLUSTER_HEARTBEAT_LOST MAKE_SQLSTATE('5','8','R','0','2')
#define ERRCODE_CLUSTER_INTERCONNECT_CORRUPTED MAKE_SQLSTATE('5','8','R','0','3')
#define ERRCODE_CLUSTER_MASTER_UNAVAILABLE MAKE_SQLSTATE('5','8','R','0','4')
#define ERRCODE_CLUSTER_SCN_DRIFT_EXCESSIVE MAKE_SQLSTATE('5','8','R','0','5')
#define ERRCODE_CLUSTER_SCN_UNDERFLOW MAKE_SQLSTATE('5','8','R','0','6')
#define ERRCODE_CLUSTER_GRD_INCONSISTENT MAKE_SQLSTATE('5','8','R','0','7')
#define ERRCODE_CLUSTER_TOPOLOGY_INVALID MAKE_SQLSTATE('5','8','R','0','8')
#define ERRCODE_CLUSTER_TT_INCONSISTENT MAKE_SQLSTATE('5','8','R','0','9')
#define ERRCODE_CLUSTER_CATALOG_INCONSISTENT MAKE_SQLSTATE('5','8','R','1','0')
#define ERRCODE_CLUSTER_SINVAL_INCONSISTENT MAKE_SQLSTATE('5','8','R','1','1')
#define ERRCODE_CLUSTER_RECOVERY_FAILED MAKE_SQLSTATE('5','8','R','1','2')
#define ERRCODE_CLUSTER_CONTROLFILE_AUTHORITY_UNAVAILABLE MAKE_SQLSTATE('5','8','R','1','3')

/* Class 72 - Snapshot Failure */
#define ERRCODE_SNAPSHOT_TOO_OLD MAKE_SQLSTATE('7','2','0','0','0')

/* Class 72 - Snapshot Failure (pgrac extension) */
#define ERRCODE_CLUSTER_SNAPSHOT_TOO_OLD MAKE_SQLSTATE('7','2','R','0','1')
#define ERRCODE_CLUSTER_SNAPSHOT_UNAVAILABLE MAKE_SQLSTATE('7','2','R','0','2')
...
/* Class XX - Internal Error (pgrac extension) */
#define ERRCODE_CLUSTER_ASSERTION_FAILURE MAKE_SQLSTATE('X','X','R','0','1')
#define ERRCODE_CLUSTER_UNEXPECTED_STATE MAKE_SQLSTATE('X','X','R','0','2')
#define ERRCODE_CLUSTER_RELMAPPER_CONFLICT MAKE_SQLSTATE('X','X','R','0','3')
