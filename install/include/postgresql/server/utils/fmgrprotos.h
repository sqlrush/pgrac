...
extern Datum cluster_scn_advance_sql(PG_FUNCTION_ARGS);
extern Datum cluster_scn_current_sql(PG_FUNCTION_ARGS);
extern Datum cluster_scn_observe_sql(PG_FUNCTION_ARGS);
extern Datum cluster_get_ic_peers(PG_FUNCTION_ARGS);
extern Datum cluster_get_ic_msg_types(PG_FUNCTION_ARGS);
extern Datum cluster_get_cssd_peers(PG_FUNCTION_ARGS);
extern Datum cluster_get_quorum_state(PG_FUNCTION_ARGS);
extern Datum cluster_get_voting_disks(PG_FUNCTION_ARGS);
extern Datum cluster_get_fence_state(PG_FUNCTION_ARGS);
extern Datum cluster_get_reconfig_state(PG_FUNCTION_ARGS);
extern Datum cluster_get_grd_shards(PG_FUNCTION_ARGS);
extern Datum cluster_get_grd_entries(PG_FUNCTION_ARGS);
extern Datum cluster_get_lmd_state(PG_FUNCTION_ARGS);
extern Datum pg_cluster_lmd_inject_wait_edge(PG_FUNCTION_ARGS);
extern Datum cluster_test_inject_visibility_tt_ref(PG_FUNCTION_ARGS);
extern Datum cluster_test_clear_visibility_injects(PG_FUNCTION_ARGS);
extern Datum cluster_test_inject_subtrans_subcommitted(PG_FUNCTION_ARGS);
extern Datum cluster_undo_get_record_srf(PG_FUNCTION_ARGS);
extern Datum cluster_undo_test_force_segment_end_srf(PG_FUNCTION_ARGS);
extern Datum cluster_cr_test_construct(PG_FUNCTION_ARGS);
extern Datum cluster_cr_test_image(PG_FUNCTION_ARGS);
extern Datum cluster_block_apply_redo_test(PG_FUNCTION_ARGS);
extern Datum cluster_block_recovery_reconstruct_test(PG_FUNCTION_ARGS);
extern Datum cluster_thread_apply_redo_test(PG_FUNCTION_ARGS);
extern Datum cluster_thread_replay_test(PG_FUNCTION_ARGS);
extern Datum cluster_thread_drive_test(PG_FUNCTION_ARGS);
extern Datum cluster_thread_replay_one_test(PG_FUNCTION_ARGS);
extern Datum cluster_thread_replay_one_auto_test(PG_FUNCTION_ARGS);
extern Datum cluster_thread_local_complete_test(PG_FUNCTION_ARGS);
extern Datum cluster_thread_gate_unfreeze_test(PG_FUNCTION_ARGS);
extern Datum cluster_thread_validated_end_test(PG_FUNCTION_ARGS);
extern Datum cluster_thread_replay_slot_test(PG_FUNCTION_ARGS);
extern Datum cluster_thread_recovery_worker_run_test(PG_FUNCTION_ARGS);
extern Datum cluster_thread_recovery_launch_test(PG_FUNCTION_ARGS);
extern Datum cluster_thread_replay_slot_state_test(PG_FUNCTION_ARGS);
extern Datum cluster_reconfig_inject_dead_node_test(PG_FUNCTION_ARGS);
extern Datum cluster_thread_capability_gate_test(PG_FUNCTION_ARGS);
extern Datum pg_cluster_ges_mode_matrix(PG_FUNCTION_ARGS);
extern Datum cluster_ges_mode_compat(PG_FUNCTION_ARGS);
extern Datum cluster_ges_mode_matches_pg(PG_FUNCTION_ARGS);
