...
#define PG_VERSION_STR "PostgreSQL 16.13 on aarch64-apple-darwin25.4.0, compiled by Apple clang version 21.0.0 (clang-2100.0.123.102), 64-bit"
...
/* PGRAC: Define to 1 to build test-only injection helpers. (--enable-injection-points) */
#define ENABLE_INJECTION 1

/* Define to 1 to build with Bonjour support. (--with-bonjour) */
/* #undef USE_BONJOUR */

/* PGRAC: Define to 1 to build pgrac cluster subsystem. (--enable-cluster) */
