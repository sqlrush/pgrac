 ...
 *	    L13 CLUSTER_WAIT_EVENTS_COUNT == 95 (current spec-4.1 snapshot)
...
UT_TEST(test_cluster_wait_events_count_95)
{
	...
	UT_ASSERT_EQ((int)CLUSTER_WAIT_EVENTS_COUNT, 95);
}
...
main(void)
{
	...
	UT_RUN(test_cluster_wait_events_count_95);
