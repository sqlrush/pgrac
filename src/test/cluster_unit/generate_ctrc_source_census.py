...
_classify_owners(
    "CURRENT_MX_HEAP_PUBLISH",
    "src/backend/access/heap/heapam.c",
    ("cluster_current_mx_stamp_published", "heap_delete", "heap_lock_tuple_internal", "heap_update"),
    "REGISTERED_REFERENCE",
    "CTRC_REF_CURRENT_MX_LOCKER|CTRC_REF_CURRENT_MX_UPDATER|CTRC_REF_HOT_FOLLOW_EDGE",
    "CTRC_TARGET_EXACT_TID",
    "cluster_current_mx_stamp_apply_exact_publication",
...
_classify_owners(
    "HEAP_ITL_PUBLISH",
    "src/backend/access/heap/heapam.c",
    ("heap_delete", "heap_insert", "heap_update", "heap_lock_tuple_internal", "heap_lock_updated_tuple_rec"),
    "REGISTERED_REFERENCE",
    "CTRC_REF_HEAP_ITL_UBA",
    "CTRC_TARGET_EXACT_ITL_SLOT",
    "cluster_heap_no_retry_boundary_apply",
...
_classify_owners(
    "HEAP_ITL_REGISTER",
    "src/backend/access/heap/heapam.c",
    ("heap_delete", "heap_insert", "heap_lock_tuple_internal", "heap_lock_updated_tuple_rec", "heap_update"),
    "REGISTERED_REFERENCE",
    "CTRC_REF_HEAP_ITL_UBA",
    "CTRC_TARGET_EXACT_ITL_SLOT",
    "cluster_heap_no_retry_boundary_apply",
