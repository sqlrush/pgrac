...
UT_TEST(test_cluster_wait_events_count_is_78)
{
	/*
	 ...
	 * by spec-2.30 D8 (ClusterPcmGrdInit + ClusterPcmTransitionApply).
	 ...
	 */
	UT_ASSERT_EQ(CLUSTER_WAIT_EVENTS_COUNT, 78);
}
...
{
	UT_PLAN(4);
	UT_RUN(test_cluster_wait_events_count_is_78);
