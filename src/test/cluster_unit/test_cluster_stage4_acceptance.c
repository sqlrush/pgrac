 ...
 *	        recovery-blocked.
 *	    L5  CLUSTER_WAIT_EVENTS_COUNT current snapshot = 112 (spec-6.1 D8
...
UT_TEST(test_stage4_wait_events_count_snapshot_112)
{
...
main(void)
{
	...
	UT_RUN(test_stage4_wait_events_count_snapshot_112);
