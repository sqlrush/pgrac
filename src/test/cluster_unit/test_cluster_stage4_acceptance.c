 ...
 *	        recovery-blocked.
 *	    L5  CLUSTER_WAIT_EVENTS_COUNT current snapshot = 118 (spec-6.13 D8
...
UT_TEST(test_stage4_wait_events_count_snapshot_120)
{
...
main(void)
{
	...
	UT_RUN(test_stage4_wait_events_count_snapshot_120);
