...
#	  L6  wait event baseline 75 → 77 (PCM_GRD_INIT + PCM_TRANSITION_APPLY)
...
is($wait_event_count, '77',
   'L6 wait event baseline 77 (spec-2.30 D8 +2 PCM_GRD_INIT + PCM_TRANSITION_APPLY)');
