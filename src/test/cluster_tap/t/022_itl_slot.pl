...
is($node->safe_psql(
   ...
   '154',
   'L12a pg_stat_cluster_injections is 154 (spec-6.12e2 +1 cluster-gcs-block-bast-nudge; spec-6.15 D3 +2 xid herding/hard-limit; spec-6.12 waves a/b/i +3; full breakdown in t/015)');
