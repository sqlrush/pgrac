...
is($node->safe_psql(
   ...
   '7',
   'L12c pg_cluster_shmem 6 rows (1.5 adds no shmem regions; 1.7 adds cluster_pcm_grd; 1.10.1 adds cluster_startup_phase; 1.11 adds cluster_lmon; 1.12 adds cluster_lck)');
