...
#	  L3  pg_cluster_state.gcs category has 67 keys (cumulative through
...
# ============================================================
# L3: pg_cluster_state.gcs category has 67 keys
...
is($pair->node0->safe_psql(
   ...
   '121',
   'L5 total cluster wait event count = 121 (spec-6.13 RDMA wait surface)');
