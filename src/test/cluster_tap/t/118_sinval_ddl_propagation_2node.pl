...
#   L4  pg_stat_cluster_wait_events count == 120 (cumulative through spec-7.2)
...
# ============================================================
# L4: pg_stat_cluster_wait_events count == 120.
# ============================================================
is($pair->node0->safe_psql('postgres',
		'SELECT count(*) FROM pg_stat_cluster_wait_events'),
	'120',
	'L4 pg_stat_cluster_wait_events returns 120 rows (spec-7.2 D6 LMS data-plane wait surface)');
