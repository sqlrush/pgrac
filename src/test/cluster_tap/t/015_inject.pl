...
is( $node->safe_psql('postgres',
	...
	'128',
	'pg_stat_cluster_injections returns 128 rows (spec-5.2a +1 clean-xfer stale-holder)');
...
is( $node->safe_psql(
	...
	'128 injection point names match the full registry (spec-5.2a +1 clean-xfer stale-holder)');
