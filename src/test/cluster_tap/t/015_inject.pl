...
is( $node->safe_psql('postgres',
	...
	'138',
	'pg_stat_cluster_injections returns 138 rows (spec-5.13 +6 cluster-clean-leave-*; spec-5.53 +1 cluster-cr-skip-epoch-bump; spec-5.7 +1 cluster-ko-peer-skip-ack; spec-2.41 +1 cluster-gcs-block-stale-ship; spec-5.8 +1 cluster-lmd-force-partial-round)');
...
is( $node->safe_psql(
	...
	'138 injection point names match the full registry (spec-5.13 +6 cluster-clean-leave-*; spec-5.53 +1 cluster-cr-skip-epoch-bump; spec-5.7 +1 cluster-ko-peer-skip-ack; spec-2.41 +1 cluster-gcs-block-stale-ship; spec-5.8 +1 cluster-lmd-force-partial-round)');
