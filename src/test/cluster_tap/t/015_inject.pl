...
is( $node->safe_psql('postgres',
	...
	'102',
	'pg_stat_cluster_injections returns 97 rows (89 prior + 5 qvotec spec-2.6 D14 + 3 fence spec-2.28 D12: pre-freeze-broadcast / pre-self-fence-shutdown / post-thaw-broadcast)');
...
is( $node->safe_psql('postgres',
	...
	'77',
	'pg_stat_cluster_wait_events returns 77 rows after spec-2.30 D8');
