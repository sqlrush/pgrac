...
is( $node->safe_psql('postgres',
	...
	'131',
	'pg_stat_cluster_injections returns 131 rows (spec-5.53 +1 cluster-cr-skip-epoch-bump; spec-5.7 +1 cluster-ko-peer-skip-ack; spec-2.41 +1 cluster-gcs-block-stale-ship)');
...
is( $node->safe_psql(
	...
	'131 injection point names match the full registry (spec-5.53 +1 cluster-cr-skip-epoch-bump; spec-5.7 +1 cluster-ko-peer-skip-ack; spec-2.41 +1 cluster-gcs-block-stale-ship)');
