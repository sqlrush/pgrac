...
is( $node->safe_psql('postgres',
	...
	'118',
	'pg_stat_cluster_injections returns 114 (+4 spec-3.9 CR injection points) = 118 rows');
...
is( $node->safe_psql('postgres',
	...
	'93',
	'pg_stat_cluster_wait_events returns 93 rows after spec-2.39');
