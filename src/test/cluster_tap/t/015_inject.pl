...
is( $node->safe_psql('postgres',
	...
	'130',
	'pg_stat_cluster_injections returns 130 rows (spec-5.7 +1 cluster-ko-peer-skip-ack; spec-2.41 +1 cluster-gcs-block-stale-ship)');
