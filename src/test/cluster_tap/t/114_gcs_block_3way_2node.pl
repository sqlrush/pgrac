...
#	  L3   pg_cluster_state.gcs has 64 keys (cumulative through spec-6.13)
#	  L4   catversion lower-bound >= 202605430; wait event count == 118
...
is($pair->node0->safe_psql(
	...
	'118',
	'L4 wait event count == 118 (spec-6.13 RDMA wait surface)');
