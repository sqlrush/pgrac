...
#	  L9  pg_cluster_state.gcs category has 88 keys (spec-7.2 D6+flip) (cumulative through spec-6.14a)
...
is($pair->node0->safe_psql(
   ...
   '88',
   'L2 pg_cluster_state.gcs category has 88 keys (spec-7.2 D6+flip) (cumulative through spec-6.14a)');
