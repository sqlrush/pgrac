...
my %expect_cat = (
	...
	cr           => 61,    # 3.10/3.21/3.22 CR path(17) + 5.53 mismatch(5) + 5.54 tuple(8)
	                       # + ... + 6.12b(6) + 6.12i/6.15(16) + 2 spec-5.22f D6 fresh-ref verdict
	                       # + 2 spec-5.22d D4 authority serve (undo_authority_
	                       # {serve_hit,fail_closed}, unconditional in dump_cr)
