...
# (spec-5.54 D5); full list + count lives in t/020).
  my $expected_region_count = $has_visibility_inject ? '70' : '69'; # spec-6.1 +1 rdma; spec-5.55 +1 resolver cache; spec-5.57 +1 cr coordinator; spec-5.18 +1 node_remove; spec-6.5 +1 backup
