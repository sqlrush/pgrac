...
is($node->safe_psql('postgres',
	...
	'102',
	'pg_stat_gcluster_wait_events returns 102 rows (spec-4.12 D7 +2 ClusterWriteFenceMarkerWrite/Verify)');
...
my %expected = (
	...
	'Cluster: SCN' => 4,
	'Cluster: Reconfig' => 7,    # spec-4.12 D4: +ClusterWriteFenceMarkerWrite
