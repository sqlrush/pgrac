...
is($node->safe_psql('postgres',
	...
	'73', 'E1 pg_stat_cluster_wait_events returns 73 rows (spec-2.23 D12: +ReplyWait +ProbeCollect)');
...
is($node->safe_psql('postgres',
	...
	'73', 'E4 pg_stat_gcluster_wait_events returns 73 rows (single-node, spec-2.23 D12)');
