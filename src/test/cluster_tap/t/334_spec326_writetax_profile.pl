...
#-------------------------------------------------------------------------
#
# 334_spec326_writetax_profile.pl
#    spec-3.26 Thread B — single-node write-tax CPU PROFILE (nightly artifact).
#
...
#
# NOTES
#    v2 (spec-3.26 Thread B sharpening): the v1 profile was too coarse to find
...
#
# IDENTIFICATION
#    src/test/cluster_tap/t/334_spec326_writetax_profile.pl
#
#-------------------------------------------------------------------------
use strict;
use warnings;
