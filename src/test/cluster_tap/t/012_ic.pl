...
#      - In a default build without --with-rdma, setting tier2 prevents
#        startup with SQLSTATE 53R22 / RDMA-enabled build hint.
...
# ----------
# Switching to tier2 in a default no-RDMA build fails closed with 53R22.
# ----------
unlink $node->logfile;
