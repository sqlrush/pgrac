...
static const char *const cluster_xp_bucket_names[CLXP_NBUCKETS] = {
	...
	[CLXP_I_ITL_WAIT] = "i_itl_wait",
	[CLXP_I_TX_WAIT] = "i_tx_wait",
	[CLXP_UPDATE_SCAN] = "update_scan",
	[CLXP_UPDATE_STORAGE] = "update_storage",
	[CLXP_UPDATE_INDEX] = "update_index",
	[CLXP_R4_CR_FETCH] = "r4_cr_fetch",
	[CLXP_R4_TX_RPC] = "r4_tx_rpc",
	[CLXP_R4_SOURCE_CR_RPC] = "r4_source_cr_rpc",
	[CLXP_RESOURCE_X_ACQUIRE] = "resource_x_acquire",
