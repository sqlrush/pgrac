...
cluster_ic_local_capability_word(void)
{
	uint32 capabilities
		= PGRAC_IC_HELLO_CAP_UNDO_AUTHORITY_SERVE_V1 | PGRAC_IC_HELLO_CAP_UNDO_HORIZON_V1
		  | PGRAC_IC_HELLO_CAP_XID_NATIVE_DISABLE_V1 | PGRAC_IC_HELLO_CAP_GCS_INVAL_BUSY_V1
		  ...
		  | PGRAC_IC_HELLO_CAP_MULTIXACT_CURRENT_V1 | PGRAC_IC_HELLO_CAP_GCS_RESOURCE_X_CONVERT_V1
