...
cluster_init_guc(void)
{
	...
	DefineCustomIntVariable(
		...
		&cluster_interconnect_rdma_inline_max, 256, 0, 4096, PGC_POSTMASTER, GUC_UNIT_BYTE,
		NULL, NULL, NULL);
	...
	DefineCustomIntVariable(
		...
		&cluster_interconnect_rdma_max_send_wr, 256, 16, 4096, PGC_POSTMASTER, 0, NULL, NULL,
		NULL);
