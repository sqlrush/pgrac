...
Read the [version-pinned MVP manual](../mvp/v0.130.0-mvp.1/README.md), including
the known build limitations and multi-host deployment prerequisites. This manual
was added after the source snapshot; the release tag remains immutable.
The release number alone does not
